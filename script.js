  ...
  function calcularEdadMascotas() {
    function calcularEdad() {
      ...
      animal === "perro" ? (
        ...
        edad === 2 ? edadHumana = 24 :
        edadHumana = 24 + (edad - 2) * 4,
        tamano === "pequeno" ? peso = edad <= 12 ? edad * 2 : 24 + (edad - 12) * 1 :
        tamano === "mediano" ? peso = edad <= 12 ? edad * 2.5 : 30 + (edad - 12) * 1.5 :
        peso = edad <= 12 ? edad * 4 : 54 + (edad - 12) * 2
      ) : (
        edad === 1 ? edadHumana = 15 :
        edad === 2 ? edadHumana = 24 :
        edadHumana = 24 + (edad - 2) * 4,
        tamano === "pequeno" ? peso = 2.5 * edad + 1.5 :
        tamano === "mediano" ? peso = 3.5 * edad + 1.5 :
        peso = 5.5 * edad + 1.5
      );
